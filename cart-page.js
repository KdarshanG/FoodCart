...
for (var j = 0; j < array.length; j++) {
    var i = array[j];
    price += itemList[i-1].price;
    console.log(itemList[i-1].name);
    var mainContainer = document.getElementById("carts");
    var div = document.createElement("div");
    div.classList.add("container", "p-2", "shadow");
    var content = `
        ...
        <br>
            <div class="col-sm-5">    
                ...
                <div class="d-flex flex-column">
                    <center><img src="${itemList[i-1]["img-path"][0]}" alt"..." height="70px" width="auto"></center>
                </div>
                <br>
            </div>
            <div class="col-sm-7">
